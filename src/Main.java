...
public class Main {
    public static void main(String[] args) {
        ...
        genAlg.n = 5;
        genAlg.generation[0] = new Individual(6, 3, 90, 0.02, 0.11 );
        genAlg.generation[1] = new Individual(7,2,90,0.2,0.2);
        genAlg.generation[2] = new Individual(8,2,110,0.2,0.2);
        genAlg.generation[3] = new Individual(9,2,90,0.11,0.17);
        genAlg.generation[4] = new Individual(10,2,90,0.11,0.02);
        System.out.println();
        genAlg.evaluate();
        System.out.println("Ordenamiento de accuracy");
        for (int i = 0; i < genAlg.n; i++) {
            System.out.println("*"+genAlg.generation[i].getNumNeuronsInt() + " "+genAlg.generation[i].getAccuracy());
        }
